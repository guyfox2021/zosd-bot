...
class Database:
    ...
    async def seed_leadership_people(self):
        ...
        people = [
            ...
            ("nadpsu", "БІЛЯВЕЦЬ Сергій Якович", "Перший заступник ректора (перший проректор) з навчальної роботи Національної академії Державної прикордонної служби України", "Полковник", "Фото/НАДПСУ/БІЛЯВЕЦЬ.jpg", 1),
            ...
            ("nadpsu", "БОРОВИК Олег Васильович", "Заступник ректора (проректор) з наукової роботи Національної академії Державної прикордонної служби України", "Полковник", "Фото/НАДПСУ/БОРОВИК.jpg", 5),
        ]
        await self.conn.executemany(
